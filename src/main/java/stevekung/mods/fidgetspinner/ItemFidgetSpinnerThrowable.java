...
public class ItemFidgetSpinnerThrowable extends Item
{
    public ItemFidgetSpinnerThrowable(String name)
    {
        super();
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand)
    {
        ...
        if (!world.isRemote)
        {
            EntityFidgetSpinner entity = new EntityFidgetSpinner(world, player);
